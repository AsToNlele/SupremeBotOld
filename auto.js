...
function botting(_status, _item) {
    ...
    if (window.location.href.includes("supremenewyork") && _status) {
        ...
        if (window.location.href == `https://www.supremenewyork.com/shop/all/${itemType}`) {
            ...
            if (itemColor !== "") {
                linksFiltered.forEach((link) => {
                    console.log(link);
                    console.log(link.parentNode.parentNode.lastChild.firstChild.innerText);


                    if (link.parentNode.parentNode.lastChild.firstChild.innerText.toLowerCase() == itemColor.toLowerCase()) {
                        console.log("FOUND NODE");
                        console.log(link.parentNode.parentNode.lastChild.firstChild.innerText);
                        console.log("Link");
                        console.log(link.parentNode.parentNode.lastChild.firstChild.href);
                        linkToRedirect = link.parentNode.parentNode.lastChild.firstChild.href;
        ...
        else if (window.location.href == "https://www.supremenewyork.com/shop/cart") {
            setTimeout(() => {
                window.location.replace("https://www.supremenewyork.com/checkout");
            }, 821);
        }

        else if (window.location.href.includes("https://www.supremenewyork.com/shop/")) {
